AFRAME.registerComponent('instruction-selector',{
    ...
    initNavigation: function(){
      ...
      this.E_left.addEventListener("hitend",this.decrementIndex.bind(this));
      this.E_right.addEventListener("hitend",this.incrementIndex.bind(this));
      this.E_center.addEventListener("hitend",this.selectedItem.bind(this));
